...
const formatReadme = (data) => {
  ...
  formattedReadme.push('# TradingView SUIUSD Scanner (1H)')
  ...
  formattedReadme.push('SUIUSD recommendation scanner based on real-time TradingView data Scanner API')
...
const main = async () => {
  try {
    ...
    await fs.writeJson('datasui.json', { updated: formattedDate, data }, { spaces: 2 })

    const historyFile = 'suiprice_history.json'
    let history = []
